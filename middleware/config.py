...
PERSON_ALIASES_FILE = DATA_DIR / "person_aliases.json"
...
APPROVAL_STATUS = {
    ...
    "MERGED": "merged",                            ## Retired duplicate identity; ignored by active participant workflows.
}
...
COURT_ESTIMATE_INCLUDE_THIRD_PLACE_GAME = True
...
COURT_ESTIMATE_MINUTES_BADMINTON = 60
COURT_ESTIMATE_MINUTES_PICKLEBALL = 30
COURT_ESTIMATE_MINUTES_PICKLEBALL_35 = 30
COURT_ESTIMATE_MINUTES_TABLE_TENNIS = 20
COURT_ESTIMATE_MINUTES_TABLE_TENNIS_35 = 20
COURT_ESTIMATE_MINUTES_TENNIS = 60
...
TEAM_RESOURCE_TYPE_SOCCER      = "Soccer Field"
...
# Canonical venue resource names and short ID prefixes.
RESOURCE_TYPE_ALIASES = {
    "basketball court": GYM_RESOURCE_TYPE_BASKETBALL,
    "basketball courts": GYM_RESOURCE_TYPE_BASKETBALL,
    "volleyball court": GYM_RESOURCE_TYPE_VOLLEYBALL,
    "volleyball courts": GYM_RESOURCE_TYPE_VOLLEYBALL,
    "bc station": TEAM_RESOURCE_TYPE_BIBLE_CHALLENGE,
    "jeopardy stage": TEAM_RESOURCE_TYPE_BIBLE_CHALLENGE,
    "bible challenge station": TEAM_RESOURCE_TYPE_BIBLE_CHALLENGE,
    "soccer field": TEAM_RESOURCE_TYPE_SOCCER,
    "soccer fields": TEAM_RESOURCE_TYPE_SOCCER,
    "tennis court": POD_RESOURCE_TYPE_TENNIS,
    "tennis courts": POD_RESOURCE_TYPE_TENNIS,
    "pickleball court": POD_RESOURCE_TYPE_PICKLEBALL,
    "pickleball courts": POD_RESOURCE_TYPE_PICKLEBALL,
    "badminton court": POD_RESOURCE_TYPE_BADMINTON,
    "badminton courts": POD_RESOURCE_TYPE_BADMINTON,
    "table tennis table": POD_RESOURCE_TYPE_TABLE_TENNIS,
    "table tennis station": POD_RESOURCE_TYPE_TABLE_TENNIS,
    "ping pong table": POD_RESOURCE_TYPE_TABLE_TENNIS,
}

RESOURCE_ID_PREFIX_BY_TYPE = {
    GYM_RESOURCE_TYPE: "GYM",
    GYM_RESOURCE_TYPE_BASKETBALL: "BB",
    GYM_RESOURCE_TYPE_VOLLEYBALL: "VB",
    TEAM_RESOURCE_TYPE_BIBLE_CHALLENGE: "BC",
    TEAM_RESOURCE_TYPE_SOCCER: "SOC",
    POD_RESOURCE_TYPE_TENNIS: "TEN",
    POD_RESOURCE_TYPE_PICKLEBALL: "PCK",
    POD_RESOURCE_TYPE_TABLE_TENNIS: "TT",
    POD_RESOURCE_TYPE_BADMINTON: "BAD",
}
...
# Private stale-to-canonical ChMeetings person ID map.
