...
#NOTE: The above line assumes the Excel engine supports IMAGE formula, which is not standard in pandas and will insert "@" after "="
    ...
    # _build_pod_entries_review_rows is provided by ScheduleWorkbookBuilder via the
    # setattr loop below; the former copy that lived here was removed in v1.08
    # (Issue #160) to eliminate the divergent matching algorithm.
                ...
                if include_venue_capacity:
                    try:
                        ...
                        schedule_input = self.write_schedule_input_json(
                            ...
                            match_schedule_overrides_path=filepath.parent / "match_schedule_overrides.json",
                        )
...
_SCHEDULE_WORKBOOK_METHOD_NAMES = (
    ...
    "_team_state_to_unit",
    "_make_shared_athlete_edge",
    "_build_cross_sport_conflicts",
    ...
    "_warn_if_resource_slot_minutes_differ_from_config",
